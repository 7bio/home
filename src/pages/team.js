...
const personData = {
  "mizuno": {
    ...
    bio: '11 years of experience in sensor design, in vitro and in vivo functional disease modeling, biochemistry and molecular biology. ARCS Scholar, Loren D. Carlson dissertation award recipient, Max Kleiber gradate research award recipient, 3-Minute Pitch winner.',
  },
  "tian": {
    photo: LinPortrait,
    name: 'Lin Tian, Ph.D.',
...
export default () => (
  <Layout >
    <div className="page-layout-team page-layout">
      ...
      <OnePersonLeadership name={ personData.mizuno.name } subheading={ personData.mizuno.subheading } bio={ personData.mizuno.bio } photo={ personData.mizuno.photo }/>
      <OnePersonLeadership name={ personData.tian.name } subheading={ personData.tian.subheading } bio={ personData.tian.bio } photo={ personData.tian.photo }/>
